...
const DATASET = [
    ...
    },
    {
        ...
        refStrokes: [
            [{x:100,y:40},{x:85,y:70},{x:90,y:110}],
            [{x:70,y:90},{x:160,y:80},{x:190,y:120},{x:130,y:180},{x:80,y:200}],
            [{x:160,y:150},{x:185,y:175}]
        ]
    },
    {
        ...
        refStrokes: [
            ...
            [{x:60,y:100},{x:140,y:95},{x:210,y:100}],
            [{x:150,y:60},{x:140,y:120},{x:110,y:170},{x:90,y:195},{x:130,y:200}]
        ]
    },
    {
        char: 'く', name: 'Hiragana Ku', reading: 'ku', type: 'hiragana', expectedStrokes: 1,
        refStrokes: [
            [{x:160,y:60},{x:90,y:120},{x:170,y:190}]
        ]
    },
    {
        char: 'け', name: 'Hiragana Ke', reading: 'ke', type: 'hiragana', expectedStrokes: 3,
        refStrokes: [
            [{x:90,y:50},{x:85,y:120},{x:80,y:190}],
            [{x:110,y:70},{x:170,y:65},{x:200,y:100},{x:160,y:150},{x:110,y:185}],
            [{x:160,y:160},{x:185,y:185}]
        ]
    },
    {
        char: 'こ', name: 'Hiragana Ko', reading: 'ko', type: 'hiragana', expectedStrokes: 2,
        refStrokes: [
            [{x:90,y:70},{x:150,y:65},{x:200,y:75}],
            [{x:70,y:130},{x:100,y:180},{x:160,y:200},{x:210,y:175},{x:215,y:140}]
        ]
    },
    {
    ...
    },
    {
        ...
        refStrokes: [
            [{x:80,y:70},{x:160,y:65},{x:200,y:90},{x:170,y:130}],
            [{x:150,y:110},{x:190,y:140},{x:170,y:180},{x:130,y:195},{x:110,y:170}]
        ]
    },
    {
        char: 'せ', name: 'Hiragana Se', reading: 'se', type: 'hiragana', expectedStrokes: 3,
        refStrokes: [
            [{x:70,y:90},{x:150,y:85},{x:210,y:95}],
            [{x:110,y:60},{x:100,y:130},{x:80,y:180},{x:60,y:200}],
            [{x:140,y:140},{x:175,y:160}]
        ]
    },
    {
        char: 'そ', name: 'Hiragana So', reading: 'so', type: 'hiragana', expectedStrokes: 1,
        refStrokes: [
            [{x:90,y:60},{x:160,y:70},{x:120,y:110},{x:190,y:160},{x:110,y:200}]
        ]
    },
    {
        ...
        refStrokes: [
            [{x:90,y:50},{x:80,y:90}],
            [{x:60,y:110},{x:140,y:105},{x:200,y:110}],
            [{x:110,y:70},{x:105,y:140},{x:85,y:190},{x:65,y:205}],
            [{x:160,y:150},{x:185,y:175}]
        ]
    },
    {
    ...
    },
    {
        ...
        refStrokes: [
            [{x:160,y:70},{x:100,y:80},{x:75,y:120},{x:95,y:165},{x:160,y:180},{x:200,y:160}]
        ]
    },
    {
        char: 'て', name: 'Hiragana Te', reading: 'te', type: 'hiragana', expectedStrokes: 1,
        refStrokes: [
            [{x:70,y:70},{x:170,y:65},{x:190,y:100},{x:130,y:170},{x:80,y:200}]
        ]
    },
    {
        char: 'と', name: 'Hiragana To', reading: 'to', type: 'hiragana', expectedStrokes: 2,
        refStrokes: [
            [{x:90,y:50},{x:85,y:100}],
            [{x:100,y:80},{x:170,y:75},{x:195,y:110},{x:150,y:170},{x:90,y:200}]
        ]
    },
    {
        char: 'な', name: 'Hiragana Na', reading: 'na', type: 'hiragana', expectedStrokes: 4,
        refStrokes: [
            [{x:60,y:70},{x:140,y:65},{x:200,y:70}],
            [{x:110,y:50},{x:105,y:130},{x:95,y:190}],
            [{x:150,y:110},{x:190,y:100},{x:200,y:140}],
            [{x:190,y:140},{x:160,y:180},{x:130,y:165},{x:150,y:140}]
        ]
    },
    {
        char: 'に', name: 'Hiragana Ni', reading: 'ni', type: 'hiragana', expectedStrokes: 3,
        refStrokes: [
            [{x:70,y:60},{x:68,y:120}],
            [{x:70,y:150},{x:68,y:195}],
            [{x:110,y:55},{x:190,y:60},{x:195,y:140},{x:160,y:190},{x:110,y:195}]
        ]
    },
    {
    ...
    },
    {
        ...
        refStrokes: [
            [{x:80,y:60},{x:75,y:140},{x:70,y:200}],
            [{x:100,y:80},{x:170,y:75},{x:195,y:120},{x:150,y:175},{x:95,y:200}],
            [{x:150,y:150},{x:185,y:175},{x:160,y:200}]
        ]
    },
    {
    ...
    },
    {
        ...
        refStrokes: [
            [{x:80,y:50},{x:75,y:130},{x:70,y:200}],
            [{x:100,y:70},{x:100,y:190}],
            [{x:130,y:90},{x:190,y:85},{x:200,y:130},{x:170,y:160},{x:130,y:150},{x:130,y:110}]
        ]
    },
    {
        char: 'ひ', name: 'Hiragana Hi', reading: 'hi', type: 'hiragana', expectedStrokes: 1,
        refStrokes: [
            [{x:80,y:90},{x:150,y:60},{x:190,y:90},{x:160,y:150},{x:100,y:190}]
        ]
    },
    {
    ...
    },
    {
        ...
        refStrokes: [
            [{x:70,y:150},{x:140,y:70},{x:210,y:150}]
        ]
    },
    {
        ...
        refStrokes: [
            [{x:80,y:50},{x:75,y:130},{x:70,y:200}],
            [{x:55,y:110},{x:130,y:105},{x:200,y:110}],
            [{x:140,y:60},{x:135,y:190}],
            [{x:160,y:120},{x:200,y:115},{x:205,y:150},{x:175,y:175},{x:140,y:165},{x:145,y:135}]
        ]
    },
    {
    ...
    },
    {
        ...
        refStrokes: [
            [{x:70,y:70},{x:150,y:65},{x:195,y:90}],
            [{x:130,y:90},{x:125,y:150},{x:100,y:190},{x:80,y:205},{x:110,y:215},{x:140,y:195}]
        ]
    },
    {
    ...
    },
    {
        ...
        refStrokes: [
            ...
            [{x:70,y:120},{x:145,y:105},{x:220,y:120}]
        ]
    },
    {
    ...
    },
    {
        ...
        refStrokes: [
            [{x:80,y:60},{x:140,y:55},{x:200,y:70}],
            [{x:80,y:100},{x:60,y:150},{x:80,y:190},{x:130,y:200},{x:170,y:180},{x:165,y:150}]
        ]
    },
    {
        char: 'り', name: 'Hiragana Ri', reading: 'ri', type: 'hiragana', expectedStrokes: 2,
        refStrokes: [
            [{x:90,y:50},{x:85,y:140},{x:80,y:190}],
            [{x:140,y:90},{x:150,y:150},{x:130,y:190},{x:160,y:210}]
        ]
    },
    {
        char: 'る', name: 'Hiragana Ru', reading: 'ru', type: 'hiragana', expectedStrokes: 1,
        refStrokes: [
            [{x:100,y:60},{x:170,y:60},{x:185,y:110},{x:120,y:160},{x:160,y:195}]
        ]
    },
    {
        ...
        refStrokes: [
            [{x:80,y:60},{x:75,y:140},{x:70,y:200}],
            [{x:100,y:90},{x:170,y:85},{x:195,y:120},{x:150,y:170},{x:170,y:200}]
        ]
    },
    {
        char: 'ろ', name: 'Hiragana Ro', reading: 'ro', type: 'hiragana', expectedStrokes: 1,
        refStrokes: [
            [{x:90,y:60},{x:170,y:60},{x:190,y:110},{x:130,y:170},{x:80,y:195}]
        ]
    },
    {
        char: 'わ', name: 'Hiragana Wa', reading: 'wa', type: 'hiragana', expectedStrokes: 2,
        refStrokes: [
            [{x:60,y:75},{x:100,y:65}],
            [{x:150,y:60},{x:200,y:90},{x:190,y:150},{x:140,y:190},{x:90,y:185},{x:75,y:150}]
        ]
    },
    {
 ...
 [{'x': 80, 'y': 50}, {'x': 80, 'y': 100}, {'x': 95, 'y': 150}, {'x': 140, 'y': 170}, {'x': 190, 'y': 150}], [{'x': 170, 'y': 80}, {'x': 200, 'y': 110}, {'x': 180, 'y': 140}], [{'x': 150, 'y': 160}, {'x': 170, 'y': 180}, {'x': 130, 'y': 190}]]
    ...
    },
    {
        ...
        refStrokes: [
            [{x:100,y:50},{x:95,y:140},{x:70,y:195}],
            [{x:140,y:80},{x:190,y:110},{x:160,y:160}]
        ]
    },
    {
        ...
        refStrokes: [
            ...
            [{x:90,y:110},{x:170,y:105}],
            [{x:140,y:60},{x:110,y:140},{x:70,y:200}]
        ]
    },
    {
        char: 'ク', name: 'Katakana Ku', reading: 'ku', type: 'katakana', expectedStrokes: 2,
        refStrokes: [
            [{x:80,y:60},{x:110,y:90}],
            [{x:170,y:50},{x:110,y:110},{x:190,y:200}]
        ]
    },
    {
        char: 'ケ', name: 'Katakana Ke', reading: 'ke', type: 'katakana', expectedStrokes: 3,
        refStrokes: [
            [{x:90,y:50},{x:85,y:110}],
            [{x:130,y:60},{x:190,y:60},{x:150,y:150},{x:100,y:200}],
            [{x:150,y:160},{x:180,y:190}]
        ]
    },
    {
        char: 'コ', name: 'Katakana Ko', reading: 'ko', type: 'katakana', expectedStrokes: 2,
        refStrokes: [
            [{x:80,y:60},{x:200,y:55}],
            [{x:80,y:60},{x:75,y:190},{x:200,y:195}]
        ]
    },
    {
        char: 'サ', name: 'Katakana Sa', reading: 'sa', type: 'katakana', expectedStrokes: 3,
        refStrokes: [
            [{x:70,y:70},{x:130,y:65}],
            [{x:170,y:50},{x:175,y:110}],
            [{x:60,y:110},{x:140,y:105},{x:210,y:120},{x:160,y:190},{x:100,y:200}]
        ]
    },
    {
        char: 'シ', name: 'Katakana Shi', reading: 'shi', type: 'katakana', expectedStrokes: 3,
        refStrokes: [
            [{x:80,y:70},{x:100,y:95}],
            [{x:110,y:110},{x:135,y:135}],
            [{x:150,y:155},{x:110,y:190},{x:70,y:200}]
        ]
    },
    {
        char: 'ス', name: 'Katakana Su', reading: 'su', type: 'katakana', expectedStrokes: 2,
        refStrokes: [
            [{x:160,y:55},{x:90,y:110}],
            [{x:70,y:80},{x:140,y:90},{x:190,y:140},{x:140,y:190},{x:90,y:180}]
        ]
    },
    {
        char: 'セ', name: 'Katakana Se', reading: 'se', type: 'katakana', expectedStrokes: 2,
        refStrokes: [
            [{x:70,y:90},{x:170,y:85},{x:190,y:60}],
            [{x:100,y:60},{x:95,y:140},{x:75,y:200}]
        ]
    },
    {
        char: 'ソ', name: 'Katakana So', reading: 'so', type: 'katakana', expectedStrokes: 2,
        refStrokes: [
            [{x:90,y:55},{x:120,y:90}],
            [{x:170,y:50},{x:110,y:120},{x:190,y:200}]
        ]
    },
    {
        char: 'タ', name: 'Katakana Ta', reading: 'ta', type: 'katakana', expectedStrokes: 3,
        refStrokes: [
            [{x:80,y:55},{x:110,y:85}],
            [{x:70,y:100},{x:190,y:95}],
            [{x:160,y:60},{x:120,y:140},{x:70,y:200}]
        ]
    },
    {
        ...
        refStrokes: [
            [{x:70,y:70},{x:190,y:65}],
            [{x:150,y:50},{x:140,y:120},{x:100,y:170},{x:70,y:200}]
        ]
    },
    {
        ...
        refStrokes: [
            [{x:80,y:60},{x:95,y:95}],
            [{x:130,y:55},{x:145,y:90}],
            [{x:190,y:70},{x:140,y:140},{x:80,y:180},{x:60,y:160}]
        ]
    },
    {
        char: 'テ', name: 'Katakana Te', reading: 'te', type: 'katakana', expectedStrokes: 2,
        refStrokes: [
            [{x:60,y:70},{x:200,y:65}],
            [{x:130,y:50},{x:125,y:120},{x:90,y:170},{x:60,y:195}]
        ]
    },
    {
        char: 'ト', name: 'Katakana To', reading: 'to', type: 'katakana', expectedStrokes: 2,
        refStrokes: [
            [{x:90,y:50},{x:85,y:150},{x:70,y:200}],
            [{x:110,y:100},{x:190,y:150}]
        ]
    },
    {
    ...
    },
    {
        ...
        refStrokes: [
            [{x:140,y:40},{x:155,y:60}],
            [{x:70,y:80},{x:200,y:75}],
            [{x:135,y:60},{x:130,y:150},{x:110,y:195}],
            [{x:90,y:130},{x:190,y:180}]
        ]
    },
    {
    ...
    },
    {
        ...
        refStrokes: [
            [{x:130,y:50},{x:90,y:130},{x:60,y:200}],
            [{x:150,y:50},{x:190,y:130},{x:220,y:200}]
        ]
    },
    {
        char: 'ヒ', name: 'Katakana Hi', reading: 'hi', type: 'katakana', expectedStrokes: 2,
        refStrokes: [
            [{x:100,y:50},{x:95,y:160},{x:85,y:195}],
            [{x:95,y:140},{x:160,y:135},{x:205,y:110}]
        ]
    },
    {
        char: 'フ', name: 'Katakana Fu', reading: 'fu', type: 'katakana', expectedStrokes: 1,
        refStrokes: [
            [{x:70,y:70},{x:190,y:65},{x:150,y:140},{x:100,y:200}]
        ]
    },
    {
        char: 'ヘ', name: 'Katakana He', reading: 'he', type: 'katakana', expectedStrokes: 1,
        refStrokes: [
            [{x:70,y:140},{x:140,y:70},{x:210,y:140}]
        ]
    },
    {
        char: 'ホ', name: 'Katakana Ho', reading: 'ho', type: 'katakana', expectedStrokes: 4,
        refStrokes: [
            [{x:135,y:50},{x:130,y:150},{x:115,y:195}],
            [{x:70,y:90},{x:195,y:85}],
            [{x:90,y:110},{x:60,y:170}],
            [{x:175,y:110},{x:205,y:170}]
        ]
    },
    {
        char: 'マ', name: 'Katakana Ma', reading: 'ma', type: 'katakana', expectedStrokes: 2,
        refStrokes: [
            [{x:70,y:70},{x:200,y:65}],
            [{x:150,y:65},{x:100,y:140},{x:60,y:200}]
        ]
    },
    {
    ...
    },
    {
        ...
        refStrokes: [
            [{x:170,y:50},{x:80,y:160},{x:60,y:200}],
            [{x:90,y:60},{x:200,y:200}]
        ]
    },
    {
    ...
    },
    {
        ...
        refStrokes: [
            [{x:90,y:50},{x:88,y:150},{x:85,y:200}],
            [{x:160,y:50},{x:155,y:120},{x:140,y:170},{x:160,y:200}]
        ]
    },
    {
    ...
    },
    {
        ...
        refStrokes: [
            [{x:80,y:60},{x:160,y:55}],
            [{x:190,y:60},{x:175,y:130},{x:130,y:180},{x:90,y:200}]
        ]
    },
    {
